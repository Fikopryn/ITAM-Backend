...
namespace WebApi.AssetData
{
    public partial class ICTAssetMgmtContext : DbContext
    {
        ...
        public virtual DbSet<AssetGeneralInfo> AssetGeneralInfos { get; set; } = null!;
        public virtual DbSet<AssetStatus> AssetStatuses { get; set; } = null!;
        public virtual DbSet<AssetStatusFin> AssetStatusFins { get; set; } = null!;
        public virtual DbSet<Company> Companies { get; set; } = null!;
        public virtual DbSet<Contract> Contracts { get; set; } = null!;
        public virtual DbSet<DeliveryOrder> DeliveryOrders { get; set; } = null!;
        public virtual DbSet<Dodetail> Dodetails { get; set; } = null!;
        public virtual DbSet<Employee> Employees { get; set; } = null!;
        public virtual DbSet<MasterRole> MasterRoles { get; set; } = null!;
        public virtual DbSet<ProductCatalog> ProductCatalogs { get; set; } = null!;
        public virtual DbSet<RequestPurchaseOrder> RequestPurchaseOrders { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AssetStatusFin>(entity =>
            {
                ...
                entity.Property(e => e.AssetStatusFinDesc).HasMaxLength(200);
            ...
            modelBuilder.Entity<Dodetail>(entity =>
            {
                ...
                entity.Property(e => e.DeliveryOrderNo).HasMaxLength(50);
            ...
            modelBuilder.Entity<ProductCatalog>(entity =>
            {
                ...
                entity.Property(e => e.ModelVersion).HasMaxLength(200);

                entity.Property(e => e.ModifiedBy).HasMaxLength(100);

                entity.Property(e => e.ProdCatTier1).HasMaxLength(200);

                entity.Property(e => e.ProdCatTier2).HasMaxLength(200);

                entity.Property(e => e.ProdCatTier3).HasMaxLength(200);
