...
namespace Data
{
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        public ITAssetStatusRepository AssetStatus { get; private set; }
        public ITAssetStatusFinRepository AssetStatusFin { get; private set; }
        public ITCompanyRepository Company { get; private set; }  
        public ITProductCatalogRepository ProductCatalog { get; private set; }
        public ITMasterRoleRepository MasterRole { get; private set; }
        public ITEmployeeRepository Employee { get; private set; }
        public ITContractRepository Contract { get; private set; }
        public ITRequestPurchaseOrderRepository RequestPurchaseOrder { get; private set; }
        ...
        public UnitOfWork(ApplicationContext context)
        {
            ...
            AssetStatus = new TAssetStatusRepository(_context);
            AssetStatusFin = new TAssetStatusFinRepository(_context);
            Company = new TCompanyRepository(_context);
            ProductCatalog = new TProductCatalogRepository(_context);
            MasterRole = new TMasterRoleRepository(_context);
            Employee = new TEmployeeRepository(_context);
            Contract = new TContractRepository(_context);
            RequestPurchaseOrder = new TRequestPurchaseOrderRepository(_context);
        }
